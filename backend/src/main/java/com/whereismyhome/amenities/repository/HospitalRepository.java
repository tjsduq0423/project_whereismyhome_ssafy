...
public interface HospitalRepository extends JpaRepository<Hospital, Integer> {
    ...
    @Query("select new com.whereismyhome.amenities.dto.response.HospitalResponseDto(h.id, h.name,h.phoneNumber, h.lng, h.lat) from Hospital h where st_contains(st_buffer(Point(:lng,:lat),0.01),h.localPoint)")
